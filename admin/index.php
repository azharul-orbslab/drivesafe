          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a href="#" class="nav-link">
                <span class="nav-title">Hi, Admin</span>
              </a>
            </li>
            <li class="nav-item">
          ...
          <div class="col-sm-12">
            <div class="dash-box">
              <div class="dash-box-body">
                <span class="dash-box-title">Driver Sign Up Request</span>
              </div>
            </div>
          </div>
          <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="baton">
                        <a href="driver?id=<?php echo $row['id'];?>" type="button" class="btn">View Details</a>
                    </div>
                  </td>
                </tr>
                <?php
